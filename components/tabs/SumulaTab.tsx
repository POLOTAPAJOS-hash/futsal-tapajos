                      ...
                      <div className="flex flex-col">
                        {playersA.map((p, idx) => (
                          <div key={idx} className="player-row">
                            <input className="inp-cell" placeholder="00" value={p.num} readOnly />
                            <input className="inp-name-cell" placeholder="Nome do Atleta" value={p.name} readOnly />
                            <span className="text-[0.65rem] font-black text-center">{p.role || '-'}</span>
                            <div className={`card-tog yellow ${p.y ? 'on' : ''}`}>Y</div>
                            <div className={`card-tog red ${p.r ? 'on' : ''}`}>R</div>
                          </div>
                        ))}
                      </div>
                   </div>
